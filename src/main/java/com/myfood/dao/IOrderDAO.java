...
public interface IOrderDAO extends JpaRepository<Order, Long> {
    ...
    /**
     * Retrieve all orders for a specific user, ordered by actual date in descending
     * order.
     *
     * @param userId The ID of the user for whom orders are retrieved.
     * @return List of Order entities for the specified user, ordered by actual date
     *         in descending order.
     */
